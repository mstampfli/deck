...
- `a` opens the setup palette: init, add commands/workflows/sandboxes/plugins/
  tasks, apply a document, forget; picking an entry pre-fills the `:` bar for
  editing (arrow keys move the cursor)
